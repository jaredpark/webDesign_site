...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.next_appointment'
        db.alter_column('user_interface_userprofile', 'next_appointment', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.next_appointment'
        db.alter_column('user_interface_userprofile', 'next_appointment', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'user_interface.userprofile': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '60', 'default': "''"}),
            'balance': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'decimal_places': '2', 'max_digits': '6', 'default': '0.0'}),
            ...
            'email': ('django.db.models.fields.EmailField', [], {'blank': 'True', 'max_length': '40', 'default': "''"}),
            ...
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True', 'max_length': '200', 'default': "''"}),
